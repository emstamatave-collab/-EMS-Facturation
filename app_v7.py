import sqlite3, os, re, hmac, uuid, mimetypes, json, base64, urllib.request, urllib.error
...
@app.route('/health')
def health(): return {'ok': True, 'app':'EMS Facturation V7'}
